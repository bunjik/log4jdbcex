 ...
 *
 */
public class RunningQueriesApiTest extends AbstractTest {

	/**
	 * {@link info.bunji.jdbc.rest.RunningQueriesApi#getApiName()} のためのテスト・メソッド。
	 */
	@Test
	public void testGetApiName() {
		ServletContext context = mock(ServletContext.class);
		RestApi api = new RunningQueriesApi(context);

		assertThat(api.getApiName(), is("running"));
	}

	/**
	 * {@link info.bunji.jdbc.rest.RunningQueriesApi#postMergeProcess(java.util.Map)} のためのテスト・メソッド。
	 */
	@Test
	public void testPostMergeProcess() throws Exception {
		ServletContext context = mock(ServletContext.class);
		AbstractApi api = new RunningQueriesApi(context);
